        ...
        <div className="col-span-1 min-w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <div className="overflow-auto max-h-96">
            <div className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <div className="grid grid-cols-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-200">
              ...
              <div className=" bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                {data?.getAllLeaderboards?.map((leaderboard) => {
                  return (
                    ...
                    >
                      <div className="px-6 col-span-2 whitespace-nowrap text-xl text-gray-500 dark:text-gray-200">
                        {leaderboard.username}
                      </div>
                      <div className="flex flex-row col-span-1 justify-center text-sm">
                        <div
                          title="elo"
                          className="text-black font-extrabold text-lg px-1.5 dark:text-green-400"
                        >
                          {leaderboard.elo}
                        </div>
                      </div>
