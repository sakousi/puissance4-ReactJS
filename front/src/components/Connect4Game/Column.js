        ...
        {Array(circles)
          ...
          .map((_, i) => (
            <li
              ...
              className="rounded-full min-[100px]:m-1 min-[100px]:h-8 min-[100px]:w-8 min-[375px]:h-10 min-[375px]:w-10 m-2 min-[420px]:h-12 min-[420px]:w-12 min-[500px]:h-14 min-[500px]:w-14 min-[650px]:h-20 min-[650px]:w-20 bg-gray-900"
            ></li>
          ))}
      </ul>
    </>
